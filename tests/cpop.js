module.exports = {
    ...
    "CIC advanced search: Reporte"(browser) {
      ...
      const submitButtonConsultaCPOP = 'a[href="ConsultasCPOPDefault.aspx?opPag=14"]';
      const mainQueryInputIdent = 'input[name="ctl00$ctl00$IFMainContent$DefaultContent$txtIdentificacion"]';
